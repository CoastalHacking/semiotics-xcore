/**
 */
package us.coastalhacking.semiotics.xcore.model.util;
...
public class SemioticsAdapterFactory extends AdapterFactoryImpl {
	...
	protected SemioticsSwitch<Adapter> modelSwitch =
		new SemioticsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSinkCategory(SinkCategory object) {
				return createSinkCategoryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link us.coastalhacking.semiotics.xcore.model.SinkCatalog <em>Sink Catalog</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSinkCatalogAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link us.coastalhacking.semiotics.xcore.model.SinkCategory <em>Sink Category</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSinkCategoryAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link us.coastalhacking.semiotics.xcore.model.Sink <em>Sink</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link us.coastalhacking.semiotics.xcore.model.Labeled <em>Labeled</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link us.coastalhacking.semiotics.xcore.model.Describable <em>Describable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
